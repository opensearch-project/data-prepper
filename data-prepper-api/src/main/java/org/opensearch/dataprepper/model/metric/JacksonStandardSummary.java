...
public class JacksonStandardSummary extends JacksonStandardMetric implements Summary {
    ...
    protected JacksonStandardSummary(JacksonStandardSummary.Builder builder) {
        super(builder);
    ...
    /**
     * Builder for creating JacksonStandardSummary
     *
     * @since 2.11
     */
    public static class Builder extends JacksonStandardMetric.Builder<JacksonStandardSummary.Builder> {
        ...
        /**
         * Returns a newly created {@link JacksonStandardSummary}
         * @return a JacksonStandardSummary
         * @since 2.11
         */
        public JacksonStandardSummary build() {
            this.withData(data);
