...
class JacksonStandardHistogramTest {
    ...
    private JacksonStandardHistogram histogram;

    private JacksonStandardHistogram.Builder builder;

    @BeforeEach
    public void setup() {
        builder = JacksonStandardHistogram.builder()
    ...
    public void testGetAttributes_withNull_mustBeEmpty() {
        ...
        JacksonStandardHistogram histogram = builder.build();
