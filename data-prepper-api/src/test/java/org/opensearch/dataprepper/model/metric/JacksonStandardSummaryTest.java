...
public class JacksonStandardSummaryTest {
    ...
    private JacksonStandardSummary summary;

    private JacksonStandardSummary.Builder builder;

    @BeforeEach
    public void setup() {
        builder = JacksonStandardSummary.builder()
    ...
    public void testGeTAttributes_withNull_mustBeEmpty() {
        ...
        JacksonStandardSummary summary = builder.build();
        assertThat(summary.getAttributes(),is(equalTo(null)));
    }
