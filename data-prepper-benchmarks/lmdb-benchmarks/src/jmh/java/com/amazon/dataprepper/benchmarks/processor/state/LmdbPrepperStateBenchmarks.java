...
import com.amazon.dataprepper.plugins.processor.state.LmdbPrepperState;
...
public class LmdbPrepperStateBenchmarks {
    ...
    private LmdbPrepperState<String> lmdbProcessorState;
    ...
    public void setup() {
        ...
        lmdbProcessorState = new LmdbPrepperState<>(new File(String.join("/", DB_PATH, DB_NAME)), DB_NAME, String.class);
    }
