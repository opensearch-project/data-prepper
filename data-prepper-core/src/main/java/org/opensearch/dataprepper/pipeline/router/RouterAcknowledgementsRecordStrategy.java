...
public class RouterAcknowledgementsRecordStrategy implements RouterGetRecordStrategy {
    private Set<Record> routedRecords;
    private Set<Record> referencedRecords;
    private AcknowledgementSetManager acknowledgementSetManager;
    private EventFactory eventFactory;

    public <C> RouterAcknowledgementsRecordStrategy(final EventFactory eventFactory, final AcknowledgementSetManager acknowledgementSetManager, final Collection<DataFlowComponent<C>> dataFlowComponents) {
