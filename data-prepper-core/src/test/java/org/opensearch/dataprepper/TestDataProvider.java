...
public class TestDataProvider {
    ...
    public static final String VALID_PIPELINE_SOURCE_USES_KAFKA_CLUSTER_CONFIG_FILE = "src/test/resources/valid_pipeline_source_uses_kafka_cluster_config.yml";
