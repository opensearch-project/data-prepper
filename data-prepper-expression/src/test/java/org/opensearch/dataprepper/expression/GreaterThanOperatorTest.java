...
class GreaterThanOperatorTest {
    final Operator<Boolean> objectUnderTest = new OperatorConfiguration().greaterThanOperator();
    ...
    void testEvalValidArgs() {
        ...
        assertThat(objectUnderTest.evaluate(1, 1L), is(false));
        assertThat(objectUnderTest.evaluate(2, 1.0), is(true));
        assertThat(objectUnderTest.evaluate(1, 2.0), is(false));
        assertThat(objectUnderTest.evaluate(1, 1.0), is(false));
