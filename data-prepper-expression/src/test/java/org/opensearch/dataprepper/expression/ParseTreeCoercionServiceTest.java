...
class ParseTreeCoercionServiceTest {
    ...
    @Test
    void testCoerceTerminalNodeStringType() throws ParseTreeCoercionException {
    ...
    @Test
    void testCoerceTerminalNodeJsonPointerType() throws ParseTreeCoercionException {
    ...
    @Test
    void testCoerceTerminalNodeJsonPointerTypeMissingKey() throws ParseTreeCoercionException {
    ...
    void testCoerceTerminalNodeEscapedUnsupportedType() {
        ...
        assertThrows(ParseTreeCoercionException.class, () -> objectUnderTest.coerceTerminalNode(terminalNode, testEvent));
    }

    @Test
    void testCoerceSuccess() throws ParseTreeCoercionException {
