...
class ParseTreeEvaluatorListenerTest {
    ...
    private final CoercionService coercionService = new CoercionService();
    ...
    private final ParseTreeEvaluatorListener objectUnderTest = createObjectUnderTest();
    ...
    private ParseTreeEvaluatorListener createObjectUnderTest() {
        return new ParseTreeEvaluatorListener(operators, coercionService);
    }
    ...
    void testGetResultWithDoubleWalk() {
        ...
        objectUnderTest.initialize(testEvent);
    ...
    void testSinglePrimaryExpression() {
        ...
        final String testSingleIntegerStatement = "1";
        ...
        assertThat(evaluateStatementOnEvent(testSingleIntegerStatement, testEvent), equalTo(1));
        ...
        assertThat(evaluateStatementOnEvent(testSingleEscapeJsonPointerStatement, testEvent),
                equalTo(testSingleEscapeJsonPointerStatement));
    }
    ...
    void testSimpleEqualityOperatorExpressionWithJsonPointerTypeExistingKey() {
        ...
        final String notEqualStatement = String.format("/%s != 2", testKey);
        assertThat(evaluateStatementOnEvent(equalStatement, testEvent), is(true));
        assertThat(evaluateStatementOnEvent(notEqualStatement, testEvent), is(true));
    }
    ...
    void testSimpleEqualityOperatorExpressionWithEscapeJsonPointerType() {
        ...
        final Map<String, Integer> data = Map.of(testKey, testValue);
        final Event testEvent = createTestEvent(data);
        final String notEqualStatement = String.format("\"/%s\" != %d", testKey, testValue);
        assertThat(evaluateStatementOnEvent(notEqualStatement, testEvent), is(true));
    }
