...
public class PipelineConfiguration {
    ...
    private static SinkContextPluginSetting getSinkContextPluginSettingFromSinkModel(final SinkModel sinkModel) {
        final Map<String, Object> settingsMap = Optional
                ...
                .orElseGet(HashMap::new);
        return new SinkContextPluginSetting(sinkModel.getPluginName(), settingsMap, new SinkContext(sinkModel.getTagsTargetKey(), sinkModel.getRoutes(), sinkModel.getIncludeKeys(), sinkModel.getExcludeKeys(), sinkModel.getResponseActions()));
    }
