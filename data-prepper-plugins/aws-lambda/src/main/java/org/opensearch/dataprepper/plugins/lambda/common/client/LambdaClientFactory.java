...
public final class LambdaClientFactory {
  ...
  public static LambdaAsyncClient createAsyncLambdaClient(
    ...
    return LambdaAsyncClient.builder()
        ...
        .overrideConfiguration(
            createOverrideConfiguration(maxConnectionRetries, awsSdkMetrics, sdkTimeout))
  ...
  private static ClientOverrideConfiguration createOverrideConfiguration(
    ...
    return ClientOverrideConfiguration.builder()
        ...
        .apiCallTimeout(
            sdkTimeout) //default sdk limit is 60secs, requests to lambda might fail if lambda takes >60sec to process
        .build();
  }
