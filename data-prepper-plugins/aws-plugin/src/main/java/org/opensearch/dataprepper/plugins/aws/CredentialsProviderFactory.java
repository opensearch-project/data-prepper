...
public class CredentialsProviderFactory {
    ...
    AwsCredentialsProvider providerFromOptions(AwsCredentialsOptions credentialsOptions) {
        if(credentialsOptions.getStsRoleArn().isPresent()) {
    ...
    private AwsCredentialsProvider createStsCredentials(AwsCredentialsOptions credentialsOptions) {
        ...
        final String stsRoleArn = credentialsOptions.getStsRoleArn()
                .orElseThrow(() -> new RuntimeException("An STS role ARN is required in internal code. There may be a bug in Data Prepper."));
        ...
        stsClientBuilder = credentialsOptions.getRegion()
