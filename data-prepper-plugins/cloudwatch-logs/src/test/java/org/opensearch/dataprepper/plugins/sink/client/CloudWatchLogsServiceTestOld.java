...
//
//public class CloudWatchLogsServiceTestOld {
...
//        cloudWatchLogsLimits = new CloudWatchLogsLimits(thresholdConfig.getBatchSize(), thresholdConfig.getMaxEventSizeBytes() * convertToBytesFromKiloBytes,
...
//
//        lenient().when(pluginMetrics.counter(CloudWatchLogsMetrics.CLOUDWATCH_LOGS_EVENTS_SUCCEEDED)).thenReturn(successEventCounter);
//        lenient().when(pluginMetrics.counter(CloudWatchLogsMetrics.CLOUDWATCH_LOGS_REQUESTS_SUCCEEDED)).thenReturn(requestSuccessCounter);
//        lenient().when(pluginMetrics.counter(CloudWatchLogsMetrics.CLOUDWATCH_LOGS_EVENTS_FAILED)).thenReturn(failedEventCounter);
//        lenient().when(pluginMetrics.counter(CloudWatchLogsMetrics.CLOUDWATCH_LOGS_REQUESTS_FAILED)).thenReturn(requestFailCounter);
//    }
//
//    void setThresholdForTestingRequestSize(int size) {
//        cloudWatchLogsLimits = new CloudWatchLogsLimits(10000, size, ThresholdConfig.DEFAULT_SIZE_OF_REQUEST, ThresholdConfig.DEFAULT_LOG_SEND_INTERVAL_TIME);
//    }
//
//    void setThresholdForTestingMaxRequestRequestSize() {
//        cloudWatchLogsLimits = new CloudWatchLogsLimits(10000, ThresholdConfig.DEFAULT_SIZE_OF_REQUEST * 2, ThresholdConfig.DEFAULT_SIZE_OF_REQUEST * 2, ThresholdConfig.DEFAULT_LOG_SEND_INTERVAL_TIME);
//    }
//
...
//                cloudWatchLogsLimits, thresholdConfig.getRetryCount(), ThresholdConfig.DEFAULT_BACKOFF_TIME);
//    }
//
...
//
//        try {
//            cloudWatchLogsService.processLogEvents(getSampleRecords(ThresholdConfig.DEFAULT_BATCH_SIZE * 2));
...
//
//        try {
//            cloudWatchLogsService.processLogEvents(getSampleRecords(ThresholdConfig.DEFAULT_BATCH_SIZE));
...
//
//        try {
//            cloudWatchLogsService.processLogEvents(getSampleRecords(ThresholdConfig.DEFAULT_BATCH_SIZE * 4));
//        } catch (RetransmissionLimitException e) {
...
//        CloudWatchLogsService cloudWatchLogsService = getCwlClientWithMemoryBuffer();
//
//        final Collection<Record<Event>> sampleEvents = getSampleRecordsLarge(ThresholdConfig.DEFAULT_BATCH_SIZE, ThresholdConfig.DEFAULT_EVENT_SIZE * convertToBytesFromKiloBytes - CloudWatchLogsLimits.APPROXIMATE_LOG_EVENT_OVERHEAD_SIZE - messageKeyByteSize + 1);
//
//        cloudWatchLogsService.processLogEvents(sampleEvents);
//
...
//        CloudWatchLogsService cloudWatchLogsService = getCwlClientWithMemoryBuffer();
//
//        final Collection<Record<Event>> sampleEvents = getSampleRecordsLarge(ThresholdConfig.DEFAULT_BATCH_SIZE, (ThresholdConfig.DEFAULT_EVENT_SIZE * convertToBytesFromKiloBytes - messageKeyByteSize) - CloudWatchLogsLimits.APPROXIMATE_LOG_EVENT_OVERHEAD_SIZE);
//
//        cloudWatchLogsService.processLogEvents(sampleEvents);
//
...
//        CloudWatchLogsService cloudWatchLogsService = getCwlClientWithMemoryBuffer();
//
//        cloudWatchLogsService.processLogEvents(getSampleRecordsLarge(1, ThresholdConfig.DEFAULT_SIZE_OF_REQUEST - messageKeyByteSize - CloudWatchLogsLimits.APPROXIMATE_LOG_EVENT_OVERHEAD_SIZE + 1));
//
//        verify(requestSuccessCounter, never()).increment();
//    }
//
...
//        CloudWatchLogsService cloudWatchLogsService = getCwlClientWithMemoryBuffer();
//
//        cloudWatchLogsService.processLogEvents(getSampleRecordsLarge(1, ThresholdConfig.DEFAULT_SIZE_OF_REQUEST - messageKeyByteSize - CloudWatchLogsLimits.APPROXIMATE_LOG_EVENT_OVERHEAD_SIZE));
//
...
//        CloudWatchLogsService cloudWatchLogsService = getCwlClientWithMemoryBuffer();
//
//        cloudWatchLogsService.processLogEvents(getSampleRecordsLarge(1, (ThresholdConfig.DEFAULT_SIZE_OF_REQUEST * 2) - messageKeyByteSize - CloudWatchLogsLimits.APPROXIMATE_LOG_EVENT_OVERHEAD_SIZE));
//
//        verify(requestSuccessCounter, atLeast(1)).increment();
//    }
//}