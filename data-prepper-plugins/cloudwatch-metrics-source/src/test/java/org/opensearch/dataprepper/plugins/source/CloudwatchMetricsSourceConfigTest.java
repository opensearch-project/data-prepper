...
public class CloudwatchMetricsSourceConfigTest {
    ...
    public void cloud_watch_metrics_configuration_test() throws JsonProcessingException {
        ...
        final NamespaceConfig namespaceConfig = metricsSourceConfig.getNamespaceConfigs().get(0);
        ...
        final MetricsConfig metricsConfig = namespaceConfig.getMetricsConfigs().get(0);
