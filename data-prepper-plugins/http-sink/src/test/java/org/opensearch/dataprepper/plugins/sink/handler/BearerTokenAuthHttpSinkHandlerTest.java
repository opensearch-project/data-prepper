...
public class BearerTokenAuthHttpSinkHandlerTest {
    ...
    public void authenticateTest() {
        ...
        Assertions.assertEquals(urlString, new BearerTokenAuthHttpSinkHandler(bearerTokenOptions, new PoolingHttpClientConnectionManager(),oAuthRefreshTokenManager).authenticate(httpAuthOptionsBuilder).getUrl());
    }
}
