...
final class TestCertificateHelper {
    ...
    static X509Certificate generateSignedCertificate(KeyPair subjectKeyPair, KeyPair caKeyPair,
    ...
    static Path writeCertificateToPem(X509Certificate cert, Path file) throws Exception {
    ...
    static Path writePrivateKeyToPem(KeyPair keyPair, Path file) throws Exception {
        StringWriter sw = new StringWriter();
        try (JcaPEMWriter writer = new JcaPEMWriter(sw)) {
