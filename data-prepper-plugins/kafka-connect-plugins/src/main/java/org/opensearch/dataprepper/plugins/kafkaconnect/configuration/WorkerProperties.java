...
public class WorkerProperties {
    ...
    @JsonProperty("key_converter_schemas_enable")
    ...
    @JsonProperty("value_converter_schemas_enable")
    ...
    @JsonProperty("producer_client_rack")
    private String producerClientRack;
    @JsonProperty("consumer_client_rack")
    private String consumerClientRack;
    @JsonProperty("key_converter_schema_registry_url")
    private String keyConverterSchemaRegistryUrl;
    @JsonProperty("value_converter_schema_registry_url")
    ...
    public Map<String, String> buildKafkaConnectPropertyMap() {
        ...
        workerProps.put(WorkerConfig.LISTENERS_CONFIG, String.join(",", this.getListeners()));
