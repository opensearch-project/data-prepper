...
public class PostgreSQLSourceTest {
    @Mock
    ...
    void testConstructorValidations() {
        assertThrows(IllegalArgumentException.class, () -> new PostgreSQLSource(postgreSQLConfig, pluginMetrics, pipelineDescription, null, null));
    }
}
