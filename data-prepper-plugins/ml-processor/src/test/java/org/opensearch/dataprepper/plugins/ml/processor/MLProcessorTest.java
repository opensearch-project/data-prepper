...
import static org.opensearch.dataprepper.plugins.ml.processor.MLProcessor.NUMBER_OF_ML_PROCESSOR_FAILED;
import static org.opensearch.dataprepper.plugins.ml.processor.MLProcessor.NUMBER_OF_ML_PROCESSOR_SUCCESS;
...
public class MLProcessorTest {
    ...
    void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        when(mlProcessorConfig.getServiceName()).thenReturn(ServiceName.SAGEMAKER);
    ...
    void testDoExecute_WithValidRecords() throws Exception {
        ...
        verify(mlBatchJobCreator, times(1)).createMLBatchJob(records);
    ...
    void testDoExecute_WithException() throws Exception {
        ...
        doThrow(new RuntimeException("Test Exception")).when(mlBatchJobCreator).createMLBatchJob(records);
