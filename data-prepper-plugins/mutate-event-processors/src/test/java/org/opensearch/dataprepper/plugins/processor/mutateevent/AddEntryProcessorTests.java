...
public class AddEntryProcessorTests {
    ...
    void invalid_add_when_throws_InvalidPluginConfigurationException() {
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, false, false, addWhen, null, false)));
    ...
    public void testSingleAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, false, false,null, null, false)));
    ...
    public void testSingleEntryIterativeAddValue() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, false, false,null, "message", false)));
        ...
        assertThat(editedRecords.get(0).getData().get("message", List.class),
                equalTo(List.of(Map.of("newMessage", 3))));
    }
    ...
    public void testSingleEntryIterativeAddValue_key_exists() {
        ...
        assertThat(editedRecords.get(0).getData().containsKey("message"), is(true));
        assertThat(editedRecords.get(0).getData().get("message", List.class),
                equalTo(List.of(Map.of("newMessage", 5))));
    }

    @Test
    public void testSingleEntryIterativeAddValue_overwriteIfKeyExists() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, true, false,null, "message", false)));
    ...
    public void testSingleEntryIterativeAddValue_appendIfKeyExists() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, false, true,null, "message", false)));
        ...
        assertThat(editedRecords.get(0).getData().containsKey("message"), is(true));
        assertThat(editedRecords.get(0).getData().get("message", List.class),
                equalTo(List.of(Map.of("newMessage", List.of(5, 3)))));
    }

    @Test
    public void testSingleEntryIterativeAddValueExpression() {
        String valueExpression = "/testKey";
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, valueExpression, false, false,null, "message", false)));
        ...
        assertThat(editedRecords.get(0).getData().containsKey("message"), is(true));
        assertThat(editedRecords.get(0).getData().get("message", List.class),
                equalTo(List.of(Map.of("newMessage", "testValue"))));
    }

    @Test
    public void testSingleEntryIterativeAddValueExpression_useIterateOnContext() {
        String valueExpression = "/testKey";
        when(expressionEvaluator.evaluate(eq(valueExpression), any(Event.class))).thenAnswer(invocation -> {
            Event eventArg = invocation.getArgument(1);
            return eventArg.get("testKey", String.class);
        });
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, valueExpression, false, false,null, "message", true)));
        ...
        assertThat(editedRecords.get(0).getData().containsKey("message"), is(true));
        assertThat(editedRecords.get(0).getData().get("message", List.class),
                equalTo(List.of(Map.of(
                        "newMessage", "testValue",
                        "testKey", "testValue"
                ))));
    }

    @Test
    public void testSingleEntryIterativeAddFormatValue() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, TEST_FORMAT, null, false, false,null, "message", false)));
        ...
        assertThat(editedRecords.get(0).getData().containsKey("message"), is(true));
        assertThat(editedRecords.get(0).getData().get("message", List.class),
                equalTo(List.of(Map.of("newMessage", "date-value time-value"))));
    }

    @Test
    public void testSingleEntryIterativeAddFormatValue_useIterateOnContext() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, TEST_FORMAT, null, false, false,null, "message", true)));
    ...
    public void testMultiAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, false, false,null, null, false),
                createEntry("message2", null, 4, null, null, false, false,null, null, false)));
    ...
    public void testSingleOverwriteAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, true, false,null, null, false)));
    ...
    public void testMultiOverwriteMixedAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, 3, null, null, true, false,null, null, false),
                createEntry("message", null, 4, null, null, false, false,null, null, false)));
    ...
    public void testAppendValueToExistingSimpleField() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("message", null, 3, null, null, false, true,null, null, false)));
    ...
    public void testBoolAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, true, null, null, false, false,null, null, false)));
    ...
    public void testStringAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, "string", null, null, false, false,null, null, false)));
    ...
    public void testNullAddProcessorTests() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, null, null, null, false, false,null, null, false)));
    ...
    public void testNestedAddProcessorTests() {
        ...
        obj.a = "test";
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, obj, null, null, false, false,null, null, false)));
    ...
    public void testArrayAddProcessorTests() {
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("newMessage", null, array, null, null, false, false,null, null, false)));
    ...
    public void testFloatAddProcessorTests() {
        when(mockConfig.getEntries())
                .thenReturn(createListOfEntries(createEntry("newMessage", null, 1.2, null, null, false, false,null, null, false)));
    ...
    public void testAddSingleFormatEntry() {
        when(mockConfig.getEntries())
                .thenReturn(createListOfEntries(createEntry("date-time", null, null, TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testAddMultipleFormatEntries() {
        when(mockConfig.getEntries())
                .thenReturn(createListOfEntries(createEntry("date-time", null, null, TEST_FORMAT, null, false, false,null, null, false),
                        createEntry("date-time2", null, null, ANOTHER_TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testFormatOverwritesExistingEntry() {
        when(mockConfig.getEntries())
                .thenReturn(
                        createListOfEntries(createEntry("time", null, null, TEST_FORMAT, null, true, false,null, null, false)));
    ...
    public void testFormatNotOverwriteExistingEntry() {
        when(mockConfig.getEntries())
                .thenReturn(
                        createListOfEntries(createEntry("time", null, null, TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testAppendFormatValueToExistingSimpleField() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("time", null, 3, TEST_FORMAT, null, false, true,null, null, false)));
    ...
    public void testAppendFormatValueToExistingListField() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("date-time", null, 3, TEST_FORMAT, null, false, true,null, null, false)));
    ...
    public void testFormatPrecedesValue() {
        when(mockConfig.getEntries())
                .thenReturn(
                        createListOfEntries(createEntry("date-time", null, "date-time-value", TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testFormatVariousDataTypes() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry(
                "newField", null, null, "${number-key}-${boolean-key}-${string-key}", null, false, false, null, null, false)));
    ...
    public void testBadFormatThenEntryNotAdded() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("data-time", null, null, BAD_TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testMetadataKeySetWithBadFormatThenEntryNotAdded() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry(null,"data-time", null, BAD_TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testMetadataKeyIsNotAdded_when_addWhen_condition_is_false() {
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry(null, "newMessage", 3, null, null, false, false, addWhen, null, false)));
        when(expressionEvaluator.isValidExpressionStatement(addWhen)).thenReturn(true);
    ...
    public void testMetadataKeySetWithDifferentDataTypes() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(
            createEntry(null, "newField", "newValue", null, null, false, false,null, null, false),
            createEntry(null, "newIntField", 123, null, null, false, false,null, null, false),
            createEntry(null, "newBooleanField", true, null, null, false, false,null, null, false)
            ));
    ...
    public void testMetadataKeySetWithFormatNotOverwriteExistingEntry() {
        when(mockConfig.getEntries())
                .thenReturn(
                        createListOfEntries(createEntry(null, "time", null, TEST_FORMAT, null, false, false,null, null, false)));
    ...
    public void testMetadataKeySetWithFormatOverwriteExistingEntry() {
        when(mockConfig.getEntries())
                .thenReturn(
                        createListOfEntries(createEntry(null, "time", null, TEST_FORMAT, null, true, false,null, null, false)));
    ...
    public void testMetadataKeySetAppendToExistingSimpleValue() {
        when(mockConfig.getEntries())
                .thenReturn(
                        createListOfEntries(createEntry(null, "time", "time-value2", null, null, false, true,null, null, false)));
    ...
    public void testMetadataKeyAndKeyBothNotSetThrows() {
        assertThrows(IllegalArgumentException.class, () -> createEntry(null, null, "newValue", null, null, false, false,null, null, false));
    }

    @Test
    public void testMetadataKeyAndKeyBothSetThrows() {
        assertThrows(IllegalArgumentException.class, () -> createEntry("newKey", "newMetadataKey", "newValue", null, null, false, false,null, null, false));
    }

    @Test
    public void testOnlyOneTypeOfValueIsSupported() {
        assertThrows(RuntimeException.class, () -> createEntry("newKey", "newMetadataKey", "newValue", "/newFormat", null, false, false,null, null, false));
    }

    @Test
    public void testOnlyOneTypeOfValueIsSupportedWithExpressionAndFormat() {
        assertThrows(RuntimeException.class, () -> createEntry("newKey", "newMetadataKey", null, "/newFormat", "length(/message)", false, false,null, null, false));
    }

    @Test
    public void testOnlyOneTypeOfValueIsSupportedWithValueAndExpressionAndFormat() {
        assertThrows(RuntimeException.class, () -> createEntry("newKey", "newMetadataKey", "value", "/newFormat", "length(/message)", false, false,null, null, false));
    }

    @Test
    public void testWithAllValuesNull() {
        assertThrows(RuntimeException.class, () -> createEntry("newKey", "newMetadataKey", null, null, null, false, false,null, null, false));
    }

    @Test
    public void testValueExpressionWithArithmeticExpression() {
        String valueExpression = "/number-key";
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("num_key", null, null, null, valueExpression, false, false,null, null, false)));
        final AddEntryProcessor processor = createObjectUnderTest();
        final Record<Event> record = getTestEventWithMultipleDataTypes();
    ...
    public void testValueExpressionWithIntegerFunctions() {
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("length_key", null, null, null, valueExpression, false, false,null, null, false)));
        final AddEntryProcessor processor = createObjectUnderTest();
        final Record<Event> record = getTestEventWithMultipleDataTypes();
        String randomString = UUID.randomUUID().toString();
    ...
    public void testValueExpressionWithIntegerFunctionsAndMetadataKey() {
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry(null, "length_key", null, null, valueExpression, false, false,null, null, false)));
        final AddEntryProcessor processor = createObjectUnderTest();
    ...
    public void testValueExpressionWithStringExpressionWithMetadataKey() {
        ...
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry(null, "newkey", null, null, valueExpression, false, false,null, null, false)));
        final AddEntryProcessor processor = createObjectUnderTest();
        final Record<Event> record = getEventWithMetadata("message", Map.of("key", "value"));
        String randomString = UUID.randomUUID().toString();
        when(expressionEvaluator.evaluate(valueExpression, record.getData())).thenReturn(randomString);
    ...
    public void testAddSingleFieldWithDynamicKey() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("${message}", null, 3, null, null, false, false,null, null, false)));
    ...
    public void testAddSingleFieldWithDynamicExpression() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("${message}_${getMetadata(\"id\")}", null, 3, null, null, false, false,null, null, false)));
    ...
    public void testAddMultipleFieldsWithDynamicKeys() {
        when(mockConfig.getEntries()).thenReturn(createListOfEntries(createEntry("${message}", null, 3, null, null, false, false,null, null, false),
                createEntry("${message}_2", null, 4, null, null, false, false,null, null, false)));
