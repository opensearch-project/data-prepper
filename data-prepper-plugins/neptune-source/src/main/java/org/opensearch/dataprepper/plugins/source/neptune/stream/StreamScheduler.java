...
//                    }
                ...
                LOG.error("Received an exception during stream processing from Neptune, backing off and retrying", e);
...
//                    }
    ...
    private StreamWorker getStreamWorker(final StreamPartition streamPartition) {
        ...
        final StreamRecordConverter recordConverter = new StreamRecordConverter(s3PathPrefix);
        return StreamWorker.create(recordBufferWriter, recordConverter, sourceConfig,
                ...
                DEFAULT_CHECKPOINT_INTERVAL_MILLS, DEFAULT_BUFFER_WRITE_INTERVAL_MILLS, 100 /* FIXME */);
    }
}
