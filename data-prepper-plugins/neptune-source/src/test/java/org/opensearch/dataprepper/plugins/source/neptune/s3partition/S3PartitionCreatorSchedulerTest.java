...
import static org.opensearch.dataprepper.plugins.source.neptune.s3partition.S3PartitionCreatorScheduler.S3_FOLDER_PREFIX;
...
public class S3PartitionCreatorSchedulerTest {
    ...
    @BeforeEach
    public void setup() {
        s3PartitionCreatorScheduler = new S3PartitionCreatorScheduler(coordinator);
    }
    ...
    void test_S3FolderPartition_exist() {
        ...
        assertThat(globalState.getPartitionKey(), is(S3_FOLDER_PREFIX));
