...
package org.opensearch.dataprepper.plugins.source.otelmetrics.grpc;
...
public class GrpcServiceConfigurator {
    ...
    public GrpcServiceConfigurator(final OTelMetricsSourceConfig config,
    ...
    public void configure(final ServerBuilder sb, final OTelMetricsGrpcService grpcService) {
