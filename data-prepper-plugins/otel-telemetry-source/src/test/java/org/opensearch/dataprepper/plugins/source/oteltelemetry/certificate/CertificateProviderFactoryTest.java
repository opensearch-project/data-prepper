...
package org.opensearch.dataprepper.plugins.source.oteltelemetry.certificate;
...
import org.opensearch.dataprepper.plugins.source.oteltelemetry.OTelTelemetrySourceConfig;
...
public class CertificateProviderFactoryTest {
    ...
    public void getCertificateProviderAcmProviderSuccess() {
        ...
        oTelTelemetrySourceConfig = OBJECT_MAPPER.convertValue(pluginSetting.getSettings(), OTelTelemetrySourceConfig.class);

        certificateProviderFactory = new CertificateProviderFactory(oTelTelemetrySourceConfig);
