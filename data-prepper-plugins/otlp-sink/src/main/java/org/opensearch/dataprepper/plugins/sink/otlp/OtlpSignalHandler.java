 ...
 *
 * @param <T> the protobuf type produced by encoding (e.g. ResourceSpans, ResourceMetrics, ResourceLogs)
 */
public interface OtlpSignalHandler<T> {
    /**
     ...
     */
    T encodeEvent(Event event) throws Exception;
     ...
     */
    long getSerializedSize(T encodedData);
     ...
     */
    byte[] buildRequestPayload(List<Pair<T, EventHandle>> batch);
