...
public class NumericTypeHandler implements PostgresDataTypeHandler {
    ...
    public Object handle(PostgresDataType columnType, String columnName, Object value) {
        ...
        if(columnType.isSubCategoryArray())
            return parseNumericArray(columnType, value.toString());
    ...
    private Object parseNumericArray(PostgresDataType columnType, String textValue) {
        switch (columnType) {
            case INT2ARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.SMALLINT, this::parseNumericValue);
            case INT4ARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.INTEGER, this::parseNumericValue);
            case INT8ARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.BIGINT, this::parseNumericValue);
            case FLOAT4ARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.REAL, this::parseNumericValue);
            case FLOAT8ARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.DOUBLE_PRECISION, this::parseNumericValue);
            case NUMERICARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.NUMERIC, this::parseNumericValue);
            case MONEYARRAY:
                return PgArrayParser.parseTypedArray(textValue, PostgresDataType.MONEY, this::parseNumericValue);
            default:
                return textValue;
        }
    }
