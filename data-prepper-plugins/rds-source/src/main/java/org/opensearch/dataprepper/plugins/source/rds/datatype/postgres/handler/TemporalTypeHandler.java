...
public class TemporalTypeHandler implements PostgresDataTypeHandler {
    ...
    public Object handle(PostgresDataType columnType, String columnName, Object value) {
        ...
        if(columnType.isSubCategoryArray())
            return parseTemporalArray(columnType, value.toString());
    ...
    private Object parseTemporalArray(PostgresDataType columnType, String val) {
        switch (columnType) {
            case DATEARRAY:
                return PgArrayParser.parseTypedArray(val, PostgresDataType.DATE, this::parseTemporalValue);
            case TIMEARRAY:
                return PgArrayParser.parseTypedArray(val, PostgresDataType.TIME, this::parseTemporalValue);
            case TIMETZARRAY:
                return PgArrayParser.parseTypedArray(val, PostgresDataType.TIMETZ, this::parseTemporalValue);
            case TIMESTAMPARRAY:
                return PgArrayParser.parseTypedArray(val, PostgresDataType.TIMESTAMP, this::parseTemporalValue);
            case TIMESTAMPTZARRAY:
                return PgArrayParser.parseTypedArray(val, PostgresDataType.TIMESTAMPTZ, this::parseTemporalValue);
            case INTERVALARRAY:
                return PgArrayParser.parseTypedArray(val, PostgresDataType.INTERVAL, this::parseTemporalValue);
            default:
                return val;
        }
    }
