...
import org.opensearch.dataprepper.plugins.s3_enrich.processor.S3EnrichProcessor;
...
public class S3ObjectWorker {
    ...
    private final S3EnrichProcessorConfig s3EnricherProcessorConfig;
    private Instant lastModified;
    private S3EnricherCacheService cacheService;

    public S3ObjectWorker(S3EnrichProcessorConfig s3EnrichProcessorConfig, InputCodec codec, BucketOwnerProvider bucketOwnerProvider, S3Client s3Client, S3ObjectPluginMetrics s3ObjectPluginMetrics, S3EnricherCacheService cacheService) {
        this.compressionOption = s3EnrichProcessorConfig.getCompression();
        this.s3EnricherProcessorConfig =  s3EnrichProcessorConfig;
        this.codec = codec;
