...
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants.CUSTOM;
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants.CUSTOM_ID;
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants.ITEMS_WITH_SPACE;
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants.NEW_LINE;
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants.TYPE_WITH_SPACE;
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants._CONFIG;
import static org.opensearch.dataprepper.plugins.source.jira.utils.Constants._SYSTEM;
...
public class JsonTypeBean {
    ...
    public String toString() {
        ...
        String sb = Constants.JSON_TYPE_BEAN +
                TYPE_WITH_SPACE + toIndentedString(type) + NEW_LINE +
                ITEMS_WITH_SPACE + toIndentedString(items) + NEW_LINE +
                _SYSTEM + toIndentedString(system) + NEW_LINE +
                CUSTOM + toIndentedString(custom) + NEW_LINE +
                CUSTOM_ID + toIndentedString(customId) + NEW_LINE +
                _CONFIG + toIndentedString(configuration) + NEW_LINE +
                CLOSING_BRACKET;
        return sb;
    }
