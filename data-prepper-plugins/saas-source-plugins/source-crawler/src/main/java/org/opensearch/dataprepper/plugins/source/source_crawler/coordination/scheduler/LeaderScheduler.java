...
public class LeaderScheduler implements Runnable {
    ...
    private final int pollingTimezoneOffsetInSeconds;

    public LeaderScheduler(EnhancedSourceCoordinator coordinator,
                           Crawler crawler,
                           int batchSize,
                           int pollingTimezoneOffsetInSeconds) {
        this.coordinator = coordinator;
        this.leaseInterval = DEFAULT_LEASE_INTERVAL;
        this.crawler = crawler;
        this.batchSize = batchSize;
        this.pollingTimezoneOffsetInSeconds = pollingTimezoneOffsetInSeconds;
    }
        ...
        while (!Thread.currentThread().isInterrupted()) {
            try {
                ...
                if (leaderPartition != null) {
                    ...
                    crawler.crawl(leaderPartition, coordinator, batchSize, pollingTimezoneOffsetInSeconds);
                }
