...
class OsgiMetricsTest {
    ...
    void bundlesLoaded_counter_is_registered_with_expected_name() throws Exception {
        final StaticBundleLoader loader = new StaticBundleLoader(felixPluginManager.getBundleContext(), bundleAdapter, meterRegistry);
    ...
    void multiple_instances_with_separate_registries_do_not_collide() throws Exception {
        ...
        final StaticBundleLoader loader1 = new StaticBundleLoader(felixPluginManager.getBundleContext(), bundleAdapter, registry1);
        final StaticBundleLoader loader2 = new StaticBundleLoader(felixPluginManager.getBundleContext(), bundleAdapter, registry2);
