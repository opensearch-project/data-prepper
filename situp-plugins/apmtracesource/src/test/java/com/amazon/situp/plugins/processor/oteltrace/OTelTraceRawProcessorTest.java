...
public class OTelTraceRawProcessorTest {
    ...
    public void testGetJsonFromProtobufObj() throws InvalidProtocolBufferException {
        ...
        ResourceSpans rs = ResourceSpans.newBuilder()
                ...
                .build();
        OTelTraceRawProcessor.getJsonFromProtobufObj(rs);
        assertThat(rs).isNotNull();
        assertThat(rs.getResource().getAttributes(0).getKey().equals("resource-key"));
        assertThat(rs.getInstrumentationLibrarySpans(0).getInstrumentationLibrary().getName().equals("test-instrumentation"));
        assertThat(rs.getInstrumentationLibrarySpans(0).getSpans(0).getName().equals("test-span"));
        assertThat(rs.getInstrumentationLibrarySpans(0).getSpans(0).getKind().equals(Span.SpanKind.CONSUMER));
    }
